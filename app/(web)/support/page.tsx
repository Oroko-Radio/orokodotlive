...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    const page = await getPageBySlug("support-the-oroko-community", isDraftMode);
    return {
      title: page.title,
    };
  } catch {
  ...
  try {
    ...
    return (
      <SinglePage
        ...
        title={page.title}
      >
        <TitleBox bgColor="red" title={page.title} slug="support" boxText="Support">
    ...
    return (
      <SinglePage
        ...
        title="Support"
      >
        <TitleBox bgColor="red" title="Support Oroko Radio" slug="support" boxText="Support">
          <div className="container max-w-5xl mx-auto">
            <p className="hidden md:block mb-4 ml-0.5 font-sans font-semibold tracking-wide text-xl lg:text-2xl">
              Support
            </p>
        ...
        <section className="container max-w-5xl mx-auto rich-text py-6 md:py-8 mb-24">
          <p>Support content is currently being migrated.</p>
        </section>
      </SinglePage>
    );
  }
